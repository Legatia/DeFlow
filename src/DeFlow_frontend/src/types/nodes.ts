  ...
  // Tier 1 Components - Communication & Web3
  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        description: 'Message content with template variable support - can be generated by AI'
      },
      {
        key: 'username',
        name: 'Bot Username',
...

  {
    ...
    configSchema: [
      ...
      },
      {
        ...
        required: true,
        placeholder: 'Your message here...\nSupports {{variable}} templates\nConnect AI Content Generator for smart content!',
        description: 'Message text with template variable support - can be generated by AI'
      },
      {
        key: 'parse_mode',
        name: 'Parse Mode',
